            ...
            if (chat.welcome) {
                ...
                for (let user of participants) {
                    ...
                    try {
                        ...
                        this.sendButton(id, text, wm, pp, [["menu", ".menu"], ["sewa", ".sewa"]], false, { mentions: [user] })    
...
global.dfail = (type, m, conn) => {
    ...
    if (msg) return conn.reply(m.chat, msg, m, { contextInfo: { externalAdReply: {title: global.wm, body: '404 Access denied ✘', sourceUrl: global.sgc, thumbnail: global.thumb}}})
